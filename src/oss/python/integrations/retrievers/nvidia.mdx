...
| :--- | :--- | :---: | :---: | :---: | :---: | :---: |
| [`NVIDIARAGRetriever`](https://python.langchain.com/api_reference/nvidia_ai_endpoints/retrievers/langchain_nvidia_ai_endpoints.retrievers.NVIDIARAGRetriever.html) | [`langchain-nvidia-ai-endpoints`](https://python.langchain.com/api_reference/nvidia_ai_endpoints/index.html) | ✅ | beta | ❌ | ![PyPI - Downloads](https://img.shields.io/pypi/dm/langchain_nvidia_ai_endpoints?style=flat-square&label=%20) | ![PyPI - Version](https://img.shields.io/pypi/v/langchain_nvidia_ai_endpoints?style=flat-square&label=%20) |
...
For detailed documentation of all `NVIDIARAGRetriever` features and configurations head to the [API reference](https://python.langchain.com/api_reference/nvidia_ai_endpoints/retrievers/langchain_nvidia_ai_endpoints.retrievers.NVIDIARAGRetriever.html).

## Related topics

- [NVIDIA Provider Page](/oss/integrations/providers/nvidia)
- [`ChatNVIDIA` integration](/oss/integrations/chat/nvidia_ai_endpoints)
- [`NVIDIAEmbeddings` integration](/oss/integrations/text_embedding/nvidia_ai_endpoints)
