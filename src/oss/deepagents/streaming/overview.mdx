...
See the [LangGraph streaming docs](/oss/langgraph/streaming#v2-streaming-format) for more details on the v2 format, including type narrowing and Pydantic/dataclass coercion.
:::
