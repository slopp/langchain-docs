...
| [Soniox](/oss/integrations/document_loaders/web_loaders/soniox) | Transcribe multilingual audio files with optional translation using Soniox API | ✅ | API |
...
<Card title="Soniox" icon="link" href="/oss/integrations/document_loaders/web_loaders/soniox" arrow="true" cta="View guide" />
